				    ...
				    <table class="wp-list-table widefat fixed posts">
                    	<thead>
                        	<tr>
                        		...
                        		<th scope="col" id="offer_by" class="manage-column column-offer_by" style="">Offer By</th>
						      ...
						      <?php while( $concierges->have_posts() ):?>
								<?php $concierges->the_post();?>
                    	           <tr id="" class="type-consignment_offer status-publish hentry alternate iedit author-other level-0">
                						...
                						<td class="offer_by column-offer_by"><?php manage_consignment_offer_custom_column('offer_by', get_the_ID());?></td>
