        ...
        class Redux_Framework_sample_config {
            ...
            public function setSections() {
                ...
                $this->sections[] = array(
                    ...
                    'desc'   => __( 'Configuation for the home page of the <a href="' . home_url() . '">bag masterpice</a> website', 'redux-framework-demo' ),
                    'icon'   => 'el-icon-home',
                    ...
                    'fields' => array(
                    		...
                    		array(
                    				...
                    				'desc'     => __( 'The background image of the home page', 'redux-framework-demo' )
                    		),
                    		...
                    		array(
                    				...
                    				'desc'     => __( 'Logo in the home page', 'redux-framework-demo' )
                    		),
                    ),
                );
                ...
                $this->sections[] = array(
                    ...
                    'fields' => array(
                    		array(
                    				...
                    				'type'     => 'media',
                    				'title'    => __( 'Logo', 'redux-framework-demo' ),
                    				'desc'     => __( 'Primary logo of the website', 'redux-framework-demo' )
                    		),
                    		array(
                    				'id'       => 'login-page-id',
                    				'type'     => 'select',
                    		...
                    		array(
                    				...
                    				'data'     => 'pages',
                    				'multi'    => false,
                    				'title'    => __( 'Register Page', 'redux-framework-demo' ),
                    		),
                    		array(
                    				'id'       => 'lostpass-page-id',
                    				'type'     => 'select',
                    				'data'     => 'pages',
                    				'multi'    => false,
                    				'title'    => __( 'Forgot Password Page', 'redux-framework-demo' ),
                    		),
                    		array(
                    				'id'       => 'resetpass-page-id',
                    				'type'     => 'select',
                    				'data'     => 'pages',
                    				'multi'    => false,
                    				'title'    => __( 'Reset Password Page', 'redux-framework-demo' ),
                    		),
                    		array(
                    				'id'       => 'sms-verification-page-id',
                    				'type'     => 'select',
                    				'data'     => 'pages',
                    				'multi'    => false,
                    				'title'    => __( 'SMS Verification Page', 'redux-framework-demo' ),
                    		),
                    		array(
                    				'id'       => 'profile-page-id',
                    				'type'     => 'select',
                    		...
                    		array(
                    				'id'       => 'concierge-page-id',
                    				'type'     => 'select',
                    				'data'     => 'pages',
                    				'multi'    => false,
                    				'title'    => __( 'Concierge Page', 'redux-framework-demo' ),
                    		),
                    		array(
                    				'id'       => 'consignment-page-id',
                    				'type'     => 'select',
                    				'data'     => 'pages',
                    				'multi'    => false,
                    				'title'    => __( 'Consignment Page', 'redux-framework-demo' ),
                    		),
                    		array(
                    				'id'       => 'footer-notice',
                    				'type'     => 'textarea',
                    				'title'    => __( 'Footer Notice', 'redux-framework-demo' ),
                    				'subtitle' => __( 'The notice in the footer section of the website in all pages.', 'redux-framework-demo' ),
                    		),
                    		array(
                    				'id'       => 'footer-copyright',
                    				'type'     => 'textarea',
                    				'title'    => __( 'Footer copyright', 'redux-framework-demo' ),
                    				'subtitle' => __( 'The copyright text in the footer section of the website in all pages.', 'redux-framework-demo' ),
                    		),
                    		array(
                    				'id'       => 'footer-logo',
                    				'type'     => 'media',
                    				'title'    => __( 'Footer Logo', 'redux-framework-demo' ),
                    				'desc'     => __( 'Secondary logo of the website placed in the footer section', 'redux-framework-demo' )
                    		),
                    		array(
                    				'id'       => 'blog-logo',
                    				'type'     => 'media',
                    		...
                    		array(
                    				...
                    				'type'     => 'media',
                    				'title'    => __( 'Membership page background', 'redux-framework-demo' ),
                    				'desc'     => __( 'Background image of the membership page.', 'redux-framework-demo' )
                    		),
                    		array(
                    				'id'       => 'login-background',
                    				'type'     => 'media',
                    				'title'    => __( 'Login page background', 'redux-framework-demo' ),
                    				'desc'     => __( 'Background image of the login page.', 'redux-framework-demo' )
                    		),
                    )
                );
                ...
                $this->sections[] = array(
                		...
                		'title'  => __( 'Special Settings', 'redux-framework-demo' ),
                		'desc'   => __( '<p class="description">Special settings for the website.</p>', 'redux-framework-demo' ),
                		'fields' => array(
                				array(
                						'id'       => 'offer-timeout-day',
                						'type'     => 'text',
                						'title'    => __( 'Offer timeout days', 'redux-framework-demo' ),
                						'desc'     => __( 'Number of days after submission the offer will be suspended.', 'redux-framework-demo' ),
                						'validate' => 'numeric',
                						'default'  => '2',
                				),
                				array(
                						'id'       => 'cart-timeout-day',
                						'type'     => 'text',
                						'title'    => __( 'Offer item in cart timeout days', 'redux-framework-demo' ),
                						'desc'     => __( 'Number of days after accepting the offer the product will be available to purchase.', 'redux-framework-demo' ),
                						'validate' => 'numeric',
                						'default'  => '2',
                				),
                		)
                ...
                $this->sections[] = array(
                		'icon'   => 'el-icon-list-alt',
                		'title'  => __( 'Page Restriction', 'redux-framework-demo' ),
                		'desc'   => __( '<p class="description">Select pages that are restriced for vistors.</p>', 'redux-framework-demo' ),
                		'fields' => array(
                				array(
                						'id'       => 'restricted-pages',
                						'type'     => 'select',
                						'data'     => 'pages',
                						'multi'    => true,
                						'title'    => __( 'Restricted Pages', 'redux-framework-demo' ),
                						'desc'     => __( 'These pages are all remain restricted for visitors of the website and will be forcefully redirected to login page.', 'redux-framework-demo' ),
                				),
                		)
                );
                ...
                $this->sections[] = array(
                		'icon'   => 'el-icon-list-alt',
                		'title'  => __( 'Consignment Prices', 'redux-framework-demo' ),
                		'desc'   => __( '<p class="description">Insert prices for various options for the consignment section.</p>', 'redux-framework-demo' ),
                		'fields' => array(
                				array(
                						'id'       => 'consignment-product',
                						'type'     => 'select',
                						'data'     => 'posts',
                						'args' => array('post_type' => array('product'), 'posts_per_page' => -1),
                						'title'    => __( 'Consignment Product', 'redux-framework-demo' ),
                ...
                $this->sections[] = array(
                		'icon'   => 'el-icon-list-alt',
                		'title'  => __( 'Home Kit Package', 'redux-framework-demo' ),
                ...
                $this->sections[] = array(
                		'icon'   => 'el-icon-list-alt',
                		'title'  => __( 'All-in Package', 'redux-framework-demo' ),
                		'desc'   => __( '<p class="description">Pricing for Home Kit Package.</p>', 'redux-framework-demo' ),
                		'subsection' => true,
                		'fields' => array(
                				array(
                				...
                				array(
                						'id'       => 'a-photographer',
                						'type'     => 'text',
                						'title'    => __( 'Photographer\'s Price', 'redux-framework-demo' ),
                						'validate' => 'numeric',
                						'default'  => '150',
                				),
                				array(
...
//                 $vip_query = new WP_User_Query( array( 'role' => 'vip', 'fields' => 'ID' ) );

//                 foreach( $vip_query as $id ){
//                 	$user_fields[] = array(
//                 						'id'       => 'restricted-pages',
//                 						'type'     => 'text',
//                 						'validate' => 'numeric',
...
//                 $this->sections[] = array(
//                 		'icon'   => 'el-icon-list-alt',
//                 		'title'  => __( 'Commision Rates', 'redux-framework-demo' ),
//                 		'subsection' => false,
//                 		'desc'   => __( '<p class="description">Insert commision rates for global or individual user.</p>', 'redux-framework-demo' ),
//                 		'fields' => array()
//                 );
