...
<div class="panel-group">
	<div class="panel-heading panel-bg" role="tab" id="headingOne">
	    <h4 class="panel-title"><?php echo apply_filters( 'woocommerce_my_account_my_orders_title', __( 'Recent Orders', 'woocommerce' ) ); ?></h4>
    </div>
	
	<div class="panel-body panel-body-style text-muted">
...
if ( $customer_orders ) : ?>
	...
	<table class="table table-condensed shop_table shop_table_responsive my_account_orders">
